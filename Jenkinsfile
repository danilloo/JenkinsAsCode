      ...
      agent any
        stages {
          ...
          stage('Backup Database') {
            ...
            sh ("/opt/mssql-tools/bin/sqlcmd -S 10.176.1.233 -U $USERNAME -P $PASSWORD -i /etc/sqlcmd/${key_path[0]}.sql")
            sh ("sleep 120")
                  }
                }
              }
          ...
          stage('Migrate Database') {
            steps {
                ...
                url: "jdbc:sqlserver://10.176.1.233:1433;databaseName=${key_path[0]}"
                  }
                }
              }
            }